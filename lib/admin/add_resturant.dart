              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration
                    (
                    label: Text('إسم المطعم', style: TextStyle(fontFamily: 'reg')),
                ...
                TextField(
                  ...
                  decoration: InputDecoration
                    (
                    label: Text('العنوان', style: TextStyle(fontFamily: 'reg')),
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(15)
                    ),
                ...
                Container(
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: ()async {
                        ...
                        await store.collection("resturants").add({"name":add1.text,"description":add2.text, "address":add3.text,});

                        uploadImage(img, "123456");
