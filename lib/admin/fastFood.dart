...
import 'admin.dart';
class AddFastFood extends StatefulWidget {
  const AddFastFood({super.key});

  @override
  State<AddFastFood> createState() => _AddFastFoodState();
}

class _AddFastFoodState extends State<AddFastFood> {
  ...
  Widget build(BuildContext context) {
    return Directionality(textDirection: TextDirection.rtl, child: Scaffold(
      appBar: AppBar(
        ...
        title: Text("إضافة وجبات سريعة", style: TextStyle(fontFamily: 'reg')),
        centerTitle: true,
      ),
                ...
                Container(
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: ()async {
                        ...
                        await store.collection("fastfood").add({"name":add1.text,"price":add2.text,"description":add3.text});
