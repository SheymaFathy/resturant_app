  ...
  Widget build(BuildContext context) {
    return Directionality(textDirection: TextDirection.rtl, child: Scaffold(
      appBar: AppBar(
        ...
        title: Text("إضافة مشروبات", style: TextStyle(fontFamily: 'reg')),
        centerTitle: true,
      ),
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration
                    (
                    label: Text('إسم المشروب', style: TextStyle(fontFamily: 'reg')),
                ...
                Container(
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: ()async {
                        ...
                        await store.collection("drink").add({"name":add1.text,"price":add3.text,"description":add2.text});
