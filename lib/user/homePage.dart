...
import 'package:resturants/models/resturant_model.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final listOfResturants = <ResturantModel>[];

  // Future<List<ResturantModel>> getResturants() async {
  //   final data = await store.collection("category").collectionGroup("category").get();
  //   listOfResturants.addAll(
  //       await data.docs.map((e) => ResturantModel.fromJson(e)).toList());
  //       print(listOfResturants[0].name);
  //       setState(() {
  //
  //       });
          ...
          title: Row(
            ...
            children: [
              ...
              Text(
                'الرئيسية',
                style:
                TextStyle(fontFamily: 'reg', fontWeight: FontWeight.bold),
              )
            ],
          ),
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return SingleCategory(
                            ...
                            cat_image:
                            myArray_cat[index]["cat_image"].toString(),
                            cat_name:
                            myArray_cat[index]["cat_name"].toString());
                      }),
                ),
                Container(
                  width: MediaQuery
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return SingleRest(
                          ...
                          rest_name:
                          myArray_rest[index]["rest_name"].toString(),
                          rest_dec: myArray_rest[index]["rest_dec"].toString(),
                          rest_image:
                          myArray_rest[index]["rest_image"].toString(),
                        );
                      }),
                ),
              ],
...
class SingleRest extends StatelessWidget {
  ...
  SingleRest({required this.rest_id,
    required this.rest_name,
    required this.rest_dec,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            rest_name,
            style: TextStyle(
                fontWeight: FontWeight.bold, fontSize: 16, fontFamily: 'reg'),
          ),
          Text(
            rest_dec,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            cat_name,
            style: TextStyle(fontFamily: 'reg', fontWeight: FontWeight.bold),
          ),
        ],
      ),
    );
