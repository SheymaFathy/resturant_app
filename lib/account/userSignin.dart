...
class _userSignInState extends State<userSignIn> {
  ...
  bool pass=true;
  Icon passIcon = Icon(Icons.visibility_off, color:mainColor,);
          ...
          Padding(
            ...
            child: Center(
              child: Text('تسجيل دخول',
                style: TextStyle(fontSize: 25,color: itemColor,fontFamily: 'reg',fontWeight: FontWeight.bold),),
            ),
          ),
                ...
                child: Column(
                            ...
                            suffixIcon:IconButton(
                              ...
                              onPressed: (){
                                setState((){
                                  pass=!pass;
                                  if(pass==false){
                                    passIcon = Icon(Icons.remove_red_eye_sharp,color:mainColor);
                                  }
                                  else{
                                    passIcon = Icon(Icons.visibility_off, color:mainColor);
                                  }
                                });
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(onPressed: (){
                          ...
                          child: Text('اشترك الآن', style: TextStyle(
                              color: itemColor,
                              fontSize: 15,
                              fontFamily: 'reg')),)
                      ],
                  ...
                  Center(
                    child: TextButton(
                      ...
                      child: Text('الدخول للوحة التحكم  ',
                        style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontFamily: 'reg',
                        fontSize: 17,
